...
// Usage example:
// $fileSupportType = FPFileSupportEnum::OBJECT_FILE_TREE;
// if ($fileSupportType === FPFileSupportEnum::OBJECT_FILE_TREE) {
//     // Handle tree structure file operations
// } elseif ($fileSupportType === FPFileSupportEnum::OBJECT_FILE_PLAIN) {
