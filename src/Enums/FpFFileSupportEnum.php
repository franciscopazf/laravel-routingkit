...
// Usage example:
// $fileSupportType = FpFFileSupportEnum::OBJECT_FILE_TREE;
// if ($fileSupportType === FpFFileSupportEnum::OBJECT_FILE_TREE) {
//     // Handle tree structure file operations
// } elseif ($fileSupportType === FpFFileSupportEnum::OBJECT_FILE_PLAIN) {
