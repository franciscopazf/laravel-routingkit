...
namespace FPJ\RoutingKit\Enums;

class FPJFileSupportEnum
{
...
// Usage example:
// $fileSupportType = FPJFileSupportEnum::OBJECT_FILE_TREE;
// if ($fileSupportType === FPJFileSupportEnum::OBJECT_FILE_TREE) {
//     // Handle tree structure file operations
// } elseif ($fileSupportType === FPJFileSupportEnum::OBJECT_FILE_PLAIN) {
