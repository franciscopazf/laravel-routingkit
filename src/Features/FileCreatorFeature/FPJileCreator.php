...
namespace FPJ\RoutingKit\Features\FileCreatorFeature;

use FPJ\RoutingKit\Contracts\FPJileCreatorInterface;
...
class FPJileCreator implements FPJileCreatorInterface
{
    ...
    /**
     * Factory method to create an instance of FPJileCreator.
     *
