...
namespace FPJ\RoutingKit\Features\DataOrchestratorFeature;
...
use FPJ\RoutingKit\Features\DataOrchestratorFeature\FPJVarsOrchestratorTrait;
use FPJ\RoutingKit\Features\DataContextFeature\FPJDataContextFactory;
use RuntimeException;
use Illuminate\Support\Collection; // Necesario para Collection en FPJVarsOrchestratorTrait


class FPJBaseOrchestrator implements FPJOrchestratorInterface
{
    use FPJVarsOrchestratorTrait {
    ...
    /**
     * @var FPJContextEntitiesInterface[] Cache para las instancias de contexto.
     * Key: contextKey, Value: FPJContextEntitiesInterface instance.
    ...
    public static function make(array $configurations): FPJOrchestratorInterface
    {
     ...
     * @return FPJContextEntitiesInterface
     * @throws RuntimeException
     */
    protected function getContextInstance(string $key, bool $forceNew = false): FPJContextEntitiesInterface
    {
     ...
     * @return FPJContextEntitiesInterface
     */
    protected function prepareContext(array $contextData): FPJContextEntitiesInterface
    {
        ...
        return FPJDataContextFactory::getDataContext(
            $contextData['key'],
            $contextData['path'],
     ...
     * @return FPJContextEntitiesInterface|null
     */
    public function getDefaultContext(bool $forceNew = false): ?FPJContextEntitiesInterface
    {
    ...
    public function getParent(FPJEntityInterface $entity): ?FPJEntityInterface
    { 
     ...
     */
    public function save(FPJEntityInterface $entity): bool
    {
        ...
        if (!($context instanceof FPJContextEntitiesInterface) || !method_exists($context, 'addEntity')) {
     ...
     *
     * @param FPJEntityInterface $entity La entidad a eliminar.
     ...
     */
    public function delete(FPJEntityInterface $entity): bool
    {
        ...
        if (!($context instanceof FPJContextEntitiesInterface) || !method_exists($context, 'removeEntity')) {
     ...
     */
    public function findById(string $id): ?FPJEntityInterface
    {
     ...
     */
    public function findByIdWithItems(string $id): ?FPJEntityInterface
    {
