...
trait FPJVarsOrchestratorTrait
{
     ...
     *
     * @param Collection $flat A flattened collection of FPJEntityInterface.
     ...
     *
     * @param FPJEntityInterface $currentNode The current node to build items for.
     * @param Collection $allEntitiesFlattened All entities in flattened form (from the source tree).
     */
    protected function buildSubTreeRecursive(FPJEntityInterface $currentNode, Collection $allEntitiesFlattened): void
    {
     ...
     */
    public function getBreadcrumbs(FPJEntityInterface $entity): Collection
    {
     ...
     * @return FPJ\RoutingKit\Contracts\FPJEntityInterface|null The root entity of the active branch, or null if not found.
     */
    public function getActiveBranch(?string $activeRouteName = null): ?FPJEntityInterface
    {
    ...
    public function getBreadcrumbsForCurrentRoute(?string $activeRouteName = null): Collection
    {
        ...
        // **CORRECCIÓN:** Asegurarse de que la entidad obtenida sea del tipo correcto FPJEntityInterface.
        ...
        if (!$activeEntity instanceof FPJEntityInterface) {
            return collect(); // No se encontró una entidad activa válida o no es del tipo correcto.
        }

        // Llama al método getBreadcrumbs con la entidad FPJEntityInterface.
    ...
    // abstract protected function getContextInstance(string $contextKey): FPJEntityInterface; // O la interfaz de tu contexto.
}
