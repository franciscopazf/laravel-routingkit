...
trait FPVarsOrchestratorTrait
{
     ...
     *
     * @param Collection $flat Una colección aplanada de FPEntityInterface (entidades raw).
     ...
     *
     * @param FPEntityInterface $currentNode El nodo actual para el que construir ítems (referencia).
     ...
     *
     * @param FPEntityInterface $node The group node to update.
     ...
     *
     * @param FPEntityInterface $node The entity node to check.
