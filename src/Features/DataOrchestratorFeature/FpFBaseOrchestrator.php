...
namespace FpF\RoutingKit\Features\DataOrchestratorFeature;
...
use FpF\RoutingKit\Features\DataOrchestratorFeature\FpFVarsOrchestratorTrait;
use FpF\RoutingKit\Features\DataContextFeature\FpFDataContextFactory;
use RuntimeException;
use Illuminate\Support\Collection; // Necesario para Collection en FpFVarsOrchestratorTrait


class FpFBaseOrchestrator implements FpFOrchestratorInterface
{
    use FpFVarsOrchestratorTrait {
    ...
    /**
     * @var FpFContextEntitiesInterface[] Cache para las instancias de contexto.
     * Key: contextKey, Value: FpFContextEntitiesInterface instance.
    ...
    public static function make(array $configurations): FpFOrchestratorInterface
    {
     ...
     * @return FpFContextEntitiesInterface
     * @throws RuntimeException
     */
    protected function getContextInstance(string $key, bool $forceNew = false): FpFContextEntitiesInterface
    {
     ...
     * @return FpFContextEntitiesInterface
     */
    protected function prepareContext(array $contextData): FpFContextEntitiesInterface
    {
        ...
        return FpFDataContextFactory::getDataContext(
            $contextData['key'],
            $contextData['path'],
     ...
     * @return FpFContextEntitiesInterface|null
     */
    public function getDefaultContext(bool $forceNew = false): ?FpFContextEntitiesInterface
    {
    ...
    public function getParent(FpFEntityInterface $entity): ?FpFEntityInterface
    { 
     ...
     */
    public function save(FpFEntityInterface $entity): bool
    {
        ...
        if (!($context instanceof FpFContextEntitiesInterface) || !method_exists($context, 'addEntity')) {
     ...
     *
     * @param FpFEntityInterface $entity La entidad a eliminar.
     ...
     */
    public function delete(FpFEntityInterface $entity): bool
    {
        ...
        if (!($context instanceof FpFContextEntitiesInterface) || !method_exists($context, 'removeEntity')) {
     ...
     */
    public function findById(string $id): ?FpFEntityInterface
    {
     ...
     */
    public function findByIdWithItems(string $id): ?FpFEntityInterface
    {
