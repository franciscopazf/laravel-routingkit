...
class FPTreeNavigator
{
    ...
    private ?FPEntityInterface $nodoInicial = null;
     ...
     */
    public function desdeNodo(FPEntityInterface $nodo): self
    {
    ...
    private function crearGrupo(Collection $rutas, ?FPEntityInterface $nodoActual, array $pila, ?string $omitId, string $label): ?string
    {
