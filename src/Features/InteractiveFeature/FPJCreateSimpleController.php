...
use FPJ\RoutingKit\Features\FileCreatorFeature\FPJileCreator;
...
class FPJCreateSimpleController
{
    ...
    {
        return FPJPrepareDataController::make()->run();
    }
    ...
    protected function crearRuta(string $id, string $accessPermission, string $urlController): void
    {
        ...
        FPJInteractiveNavigator::make(FPJRoute::class)->crear(data: [
            'id' => $id,
    ...
    {
        FPJInteractiveNavigator::make(FPJNavigation::class)->crear(data: [
            'instanceRouteId' => $id,
            'id' => $id
        ]);
    }
