...
namespace FpF\RoutingKit\Support\Facades; // Asegúrate de que el namespace sea correcto para tu paquete

use Illuminate\Support\Facades\Facade; // Importa la clase base Facade de Laravel
      
class FpFNavigation extends Facade
{
    /**
    ...
    {
        return 'fpf.navigation'; // ¡Esta cadena debe coincidir con la clave del singleton!
    }
}