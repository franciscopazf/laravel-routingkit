...
namespace FP\RoutingKit\Support\Facades; // Asegúrate de que el namespace sea correcto para tu paquete

use Illuminate\Support\Facades\Facade; // Importa la clase base Facade de Laravel
      
class FPNavigation extends Facade
{
    /**
    ...
    {
        return 'fp.navigation'; // ¡Esta cadena debe coincidir con la clave del singleton!
    }
}