...
use FPJ\RoutingKit\Contracts\FPJIsOrchestrableInterface;
use FPJ\RoutingKit\Contracts\FPJOrchestratorInterface;
use FPJ\RoutingKit\Features\DataOrchestratorFeature\FPJBaseOrchestrator;
use FPJ\RoutingKit\Features\InteractiveFeature\FPJTreeNavigator;
use FPJ\RoutingKit\Traits\HasDynamicAccessors;
use Illuminate\Support\Collection;
use RuntimeException;

/**
 * Abstract base class for all FPJ entities, providing common properties,
 * CRUD operations, and a query builder pattern for filtering entities.
 */
abstract class FPJBaseEntity implements FPJEntityInterface, FPJIsOrchestrableInterface
{
     ...
     * Key: FQCN de la clase derivada (ej. FPJNavigation::class)
     * Value: FPJOrchestratorInterface
     */
     ...
     * Key: FQCN de la clase derivada (ej. FPJNavigation::class)
     * Value: FPJBaseEntity (o su clase derivada)
     */
     ...
     * Each concrete subclass (e.g., FPJNavigation, FPJRoute) must implement this
     * to specify which Orchestrator it should use.
     *
     * @return FPJOrchestratorInterface
     */
    public static function getOrchestrator(): FPJOrchestratorInterface
    {
        return FPJBaseOrchestrator::make(static::getOrchestratorConfig());
    }
     ...
     * @return FPJOrchestratorInterface
     */
    protected static function getOrchestratorSingleton(): FPJOrchestratorInterface
    {
        $class = static::class;
     ...
     *
     * @return FPJOrchestratorInterface Una nueva instancia de orquestador limpia.
     */
    protected static function resetOrchestratorSingleton(): FPJOrchestratorInterface
    {
        $class = static::class;
     ...
     * @return static
     */
    public function setParent(FPJEntityInterface $parent): static
    {
     ...
     * @param FPJEntityInterface $item
     * @return static
     */
    public function addItem(FPJEntityInterface $item): static
    {
     ...
     * @return static
     */
    public function save(string|FPJEntityInterface|null $parent = null): static
    {
        if ($parent instanceof FPJEntityInterface) {
            $this->parentId = $parent->getId();
     ...
     */
    public static function findByIdWithItems(string $id): ?FPJEntityInterface
    {
        $entity = static::getOrchestratorSingleton()->findByIdWithItems($id);
        return $entity instanceof FPJEntityInterface ? $entity : null;
    }
     ...
     *
     * @param string|FPJEntityInterface $entity The potential parent entity.
     * @return bool
     */
     ...
     *
     * @param string|FPJEntityInterface $parent The ID or instance of the new parent entity.
     * @return static
     */
    public function moveTo(string|FPJEntityInterface $parent): static
    {
     ...
     *
     * @param FPJEntityInterface $entity The entity for which to get breadcrumbs.
     * @return Collection A collection of entities representing the breadcrumbs.
     */
    public static function getBreadcrumbs(FPJEntityInterface $entity): Collection
    {
     ...
     * @return FPJEntityInterface|null The root entity of the active branch, or null if not found.
     */
    public static function getActiveBranch(?string $activeRouteName = null): ?FPJEntityInterface
    {
