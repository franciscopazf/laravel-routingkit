...
use FpF\RoutingKit\Contracts\FpFIsOrchestrableInterface;
use FpF\RoutingKit\Contracts\FpFOrchestratorInterface;
use FpF\RoutingKit\Features\DataOrchestratorFeature\FpFBaseOrchestrator;
use FpF\RoutingKit\Features\InteractiveFeature\FpFTreeNavigator;
use FpF\RoutingKit\Traits\HasDynamicAccessors;
use Illuminate\Support\Collection;
use RuntimeException;

/**
 * Abstract base class for all FpF entities, providing common properties,
 * CRUD operations, and a query builder pattern for filtering entities.
 */
abstract class FpFBaseEntity implements FpFEntityInterface, FpFIsOrchestrableInterface
{
     ...
     * Key: FQCN de la clase derivada (ej. FpFNavigation::class)
     * Value: FpFOrchestratorInterface
     */
     ...
     * Key: FQCN de la clase derivada (ej. FpFNavigation::class)
     * Value: FpFBaseEntity (o su clase derivada)
     */
     ...
     * Each concrete subclass (e.g., FpFNavigation, FpFRoute) must implement this
     * to specify which Orchestrator it should use.
     *
     * @return FpFOrchestratorInterface
     */
    public static function getOrchestrator(): FpFOrchestratorInterface
    {
        return FpFBaseOrchestrator::make(static::getOrchestratorConfig());
    }
     ...
     * @return FpFOrchestratorInterface
     */
    protected static function getOrchestratorSingleton(): FpFOrchestratorInterface
    {
        $class = static::class;
     ...
     *
     * @return FpFOrchestratorInterface Una nueva instancia de orquestador limpia.
     */
    protected static function resetOrchestratorSingleton(): FpFOrchestratorInterface
    {
        $class = static::class;
     ...
     * @return static
     */
    public function setParent(FpFEntityInterface $parent): static
    {
     ...
     * @param FpFEntityInterface $item
     * @return static
     */
    public function addItem(FpFEntityInterface $item): static
    {
     ...
     * @return static
     */
    public function save(string|FpFEntityInterface|null $parent = null): static
    {
        if ($parent instanceof FpFEntityInterface) {
            $this->parentId = $parent->getId();
     ...
     */
    public static function findByIdWithItems(string $id): ?FpFEntityInterface
    {
        $entity = static::getOrchestratorSingleton()->findByIdWithItems($id);
        return $entity instanceof FpFEntityInterface ? $entity : null;
    }
     ...
     *
     * @param string|FpFEntityInterface $entity The potential parent entity.
     * @return bool
     */
     ...
     *
     * @param string|FpFEntityInterface $parent The ID or instance of the new parent entity.
     * @return static
     */
    public function moveTo(string|FpFEntityInterface $parent): static
    {
     ...
     *
     * @param FpFEntityInterface $entity The entity for which to get breadcrumbs.
     * @return Collection A collection of entities representing the breadcrumbs.
     */
    public static function getBreadcrumbs(FpFEntityInterface $entity): Collection
    {
     ...
     * @return FpFEntityInterface|null The root entity of the active branch, or null if not found.
     */
    public static function getActiveBranch(?string $activeRouteName = null): ?FpFEntityInterface
    {
