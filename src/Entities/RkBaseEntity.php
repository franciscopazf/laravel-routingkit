...
use Rk\RoutingKit\Contracts\RkIsOrchestrableInterface;
use Rk\RoutingKit\Contracts\RkOrchestratorInterface;
use Rk\RoutingKit\Features\DataOrchestratorFeature\RkBaseOrchestrator;
use Rk\RoutingKit\Features\InteractiveFeature\RkTreeNavigator;
use Rk\RoutingKit\Traits\HasDynamicAccessors;
use Illuminate\Support\Collection;
use RuntimeException;

/**
 * Abstract base class for all Rk entities, providing common properties,
 * CRUD operations, and a query builder pattern for filtering entities.
 */
abstract class RkBaseEntity implements RkEntityInterface, RkIsOrchestrableInterface
{
     ...
     * Key: FQCN de la clase derivada (ej. RkNavigation::class)
     * Value: RkOrchestratorInterface
     */
     ...
     * Key: FQCN de la clase derivada (ej. RkNavigation::class)
     * Value: RkBaseEntity (o su clase derivada)
     */
     ...
     * Each concrete subclass (e.g., RkNavigation, RkRoute) must implement this
     * to specify which Orchestrator it should use.
     *
     * @return RkOrchestratorInterface
     */
    public static function getOrchestrator(): RkOrchestratorInterface
    {
        ...
        return RkBaseOrchestrator::make(static::getOrchestratorConfig());
    }
     ...
     * @return RkOrchestratorInterface
     */
    protected static function getOrchestratorSingleton(): RkOrchestratorInterface
    {
        $class = static::class;
     ...
     *
     * @return RkOrchestratorInterface Una instancia de orquestador limpia.
     */
    protected static function resetOrchestratorSingleton(): RkOrchestratorInterface
    {
        $class = static::class;
     ...
     * @return static
     */
    public function setParent(RkEntityInterface $parent): static
    {
     ...
     * @return static
     */
    public function save(string|RkEntityInterface|null $parent = null): static
    {
     ...
     */
    public static function findByIdWithItems(string $id): ?RkEntityInterface
    {
        ...
        return $entity instanceof RkEntityInterface ? clone $entity : null;
    }
    ...
    public static function findById(string $id): ?RkEntityInterface
    {
        ...
        // Devolvemos un clon si se encuentra, para evitar modificaciones directas al caché.
        $entity = $filteredEntitiesCache->get($id);
        return $entity instanceof RkEntityInterface ?  $entity : null;
    }
     ...
     *
     * @param string|RkEntityInterface $entity The potential parent entity.
     * @return bool
     */
     ...
     *
     * @param string|RkEntityInterface $parent The ID or instance of the new parent entity.
     * @return static
     */
    public function moveTo(string|RkEntityInterface $parent): static
    {
     ...
     */
    public static function getBreadcrumbs(RkEntityInterface $entity): Collection
    {
     ...
     */
    public static function getActiveBranch(?string $activeRouteName = null): ?RkEntityInterface
    {
    ...
    public static function seleccionar(
        ...
        return RkTreeNavigator::make(static::all(), static::class)
     ...
     *
     * @param string|null $activeRouteName El nombre de la ruta activa. Si es null, se intenta obtener de la solicitud de Laravel.
     * @return RkEntityInterface|null El nodo activo actual, o null si no se encuentra.
     */
    public static function getCurrentActiveNode(?string $activeRouteName = null): ?RkEntityInterface
    {
     ...
     */
    public static function getParentOf(string $entityId): ?RkEntityInterface
    {
     ...
     */
    public static function getActiveNodeParentWithChildren(?string $activeRouteName = null): ?RkEntityInterface
    {
